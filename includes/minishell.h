...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/20 17:05:11 by rafpetro          #+#    #+#             */
/*   Updated: 2025/01/20 17:21:41 by rafpetro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			write_tokens(int *i, t_tokens **arr,
				int arr_i, t_minishell *minishell);
int			write_non_quote(int *i, t_tokens *token,
				int *j, t_minishell *minishell);
int			write_one_quote(char *str, int *i, t_tokens *token, int *j);
int			write_two_quote(int *i, t_tokens *token,
				int *j, t_minishell *minishell);
...
int			find_to_env_write(int *i, t_minishell	*minishell,
				char *token_str, int *k);
int			dollar_arg_len(char *str, int *index, t_minishell *minishell);
int			dollar_arg_len_quote(int *index, t_minishell *minishell);
int			write_dollar(int *index, char *token_str,
				t_minishell *minishell, int *j);
int			write_dollar_quote(int *index, char *token_str,
				t_minishell *minishell, int *j);
...
int			out_redir(int *i, int *fd, t_tokens**tokens,
				t_minishell *minishell);
int			out_append_redir(int *i, int *fd, t_tokens **tokens,
				t_minishell *minishell);
int			in_redir(int *i, int *fd, t_tokens **tokens,
				t_minishell *minishell);
...
void		find_to_env_write_helper1(int *i, int j, int *count,
				t_EnvList *env);
...
int			helper_verjnakan(t_helper *h, t_minishell *mini,
				t_tokens **tokens, int *fd);
#endif